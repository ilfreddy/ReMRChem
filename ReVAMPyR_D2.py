...
if __name__ == '__main__':
    ...
    parser.add_argument('-v', '--potential', dest='potential', type=str, default='Fermi_Dirac',
    ...
    assert args.potential in ['point_charge', 'smoothing_HFYGB', 'coulomb_HFYGB', 'homogeneus_charge_sphere', 'gaussian', 'Fermi_Dirac'], 'Please, specify V'
...
if args.potential == 'point_charge':
    ...
    #Peps = vp.ScalingProjector(mra,prec/10)
    V_tree = nucpot.Fermi_Dirac_He( origin, Z, args.box, mra,args.order, prec)
    #V_tree = Peps(f)
...
if args.readOrbitals == 'Yes':
    ...
    spinorb1.normalize()
    spinorb2 = spinorb1.ktrs(prec/10)
    spinorb2.cropLargeSmall(prec)
    spinorb2.normalize()
...
if args.coulgau == 'coulomb':
    E_tot_JK = 0
    spinorb1, spinorb2, E_tot_JK = two_electron.coulomb_gs_2e(spinorb1, V_tree, mra, prec,prec, der)
